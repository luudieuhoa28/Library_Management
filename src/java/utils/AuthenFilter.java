...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        user.add("");
        user.add("login.jsp");
        user.add("change_pass_page.jsp");
        user.add("error_page.jsp");
        user.add("login_error_page.jsp");
        user.add("register.jsp");
        user.add("search_user.jsp");
        user.add("view_cart.jsp");
        user.add("view_profile_page.jsp");
        user.add("book_infor.jsp");
        user.add("list_borrowed_book.jsp");
        user.add("BorrowBookController");
        user.add("ChangePasswordController");
        user.add("DeteleBookCartController");
        user.add("LoginController");
        user.add("LogoutController");
        user.add("MainController");
        user.add("RegisterController");
        user.add("ReturnBookController");
        user.add("SearchController");
        user.add("ShowBookInforController");
        user.add("ShowListBorrowedBookController");
        user.add("UpDateProfileController");
        user.add("UpdateCartController");
        user.add("ViewProfileController");
        user.add("AddToCardController");
        user.add("ViewCartController");
        admin = new ArrayList<>();
        admin.add("add_book_page.jsp");
        admin.add("change_pass_page.jsp");
        admin.add("error_page.jsp");
        admin.add("list_user.jsp");
        admin.add("login.jsp");
        admin.add("login_error_page.jsp");
        admin.add("register.jsp");
        admin.add("search_admin.jsp");
        admin.add("update_book.jsp");
        admin.add("view_profile_page.jsp");
        admin.add("AddBookController");
        admin.add("ChangePasswordController");
        admin.add("DeleteBookController");
        admin.add("DisableUserController");
        admin.add("EnableUserController");
        admin.add("GetListUserController");
        ...
        admin.add("UpDateProfileController");
        admin.add("ViewProfileController");
        admin.add("UpdateBookPageController");
        ...
        try {
            ...
            if (uri.contains(".jpg")
                ...
                chain.doFilter(request, response);
                    ...
                    || uri.contains("login_error_page.jsp")) {
                chain.doFilter(request, response);
            } else {
